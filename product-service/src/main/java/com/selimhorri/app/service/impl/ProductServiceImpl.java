...
public class ProductServiceImpl implements ProductService {
	...
	public ProductDto update(final Integer productId, final ProductDto productDto) {
		...
		existingProductDto.setProductTitle(productDto.getProductTitle());
		existingProductDto.setImageUrl(productDto.getImageUrl());
		existingProductDto.setSku(productDto.getSku());
		existingProductDto.setPriceUnit(productDto.getPriceUnit());
		existingProductDto.setQuantity(productDto.getQuantity());
		existingProductDto.setCategoryDto(productDto.getCategoryDto());

		return ProductMappingHelper.map(this.productRepository.save(ProductMappingHelper.map(existingProductDto)));
	}
